 ...
 * Time: 6:55 PM
 */
public class HpFolsomCloudServerApi implements CloudServerApi<HpCloudServer, HpFolsomCloudServerCreated, HpConnectDetails, HpMachineOptions, HpFolsomSshDetails> {
    ...
    @Override
    public Collection<HpFolsomCloudServerCreated> create( HpMachineOptions hpCloudMachineOptions ) {
        ...
        List<HpFolsomCloudServerCreated> newNodesList = new ArrayList<HpFolsomCloudServerCreated>( newNodes.size() );
        for( NodeMetadata newNode : newNodes ){
            newNodesList.add( new HpFolsomCloudServerCreated( newNode ) );
        }
